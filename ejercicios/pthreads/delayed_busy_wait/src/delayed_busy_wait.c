// Copyright [2023] Christopher Zuniga <christopher.zunigarojas@ucr.ac.cr>
...
int main(int argc, char* argv[]) {
  ...
  if (argc == 3) {
    ...
    if (sscanf(argv[2], "%" SCNu64, &microsegundos)) {
    } else {
      fprintf(stderr, "Error: invalid microsegundos\n");
      return 11;
    }
  }
  ...
  if (shared_data) {
    ...
    shared_data->delay = microsegundos;
    // clock get time
    ...
    (double) (finish_time.tv_nsec - start_time.tv_nsec) /  10000000000;
