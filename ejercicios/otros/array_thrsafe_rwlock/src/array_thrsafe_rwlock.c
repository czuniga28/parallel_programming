...
size_t array_find_first_private(array_rwlock_t* array, const void* element,
	size_t start_pos);
...
int array_increase_capacity(array_rwlock_t* array) {
	assert(array);
...
int array_decrease_capacity(array_rwlock_t* array) {
	assert(array);
...
size_t array_find_first(array_rwlock_t* array, const void* element, size_t start_pos) {
	assert( array );
	pthread_rwlock_rdlock( &array->rwlock );
...
int array_remove_first(array_rwlock_t* array, const void* element, size_t start_pos) {
	assert( array );
	pthread_rwlock_wrlock( &array->rwlock );
